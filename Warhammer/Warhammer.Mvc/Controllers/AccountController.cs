    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    IAuthenticatedDataProvider data =
                        DependencyResolver.Current.GetService<IAuthenticatedDataProvider>();
                    data.AddPlayer(model.Name, model.Email);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                IAuthenticatedDataProvider data = DependencyResolver.Current.GetService<IAuthenticatedDataProvider>();
                Player player = data.GetPlayer(model.Email);
                if (player != null)
                {
                    IEmailHandler email = DependencyResolver.Current.GetService<IEmailHandler>();
                    email.PasswordReset(player, callbackUrl);
                }
